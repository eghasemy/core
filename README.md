...
**True 7-Phase S-Curve Acceleration**: This fork implements the most advanced S-curve acceleration available - a true 7-phase motion profile with runtime adjustable parameters via M-codes (M204, M205, M206, M207, M208, M209). Features include adaptive jerk control, junction velocity optimization, and complete real-time parameter adjustment. This provides 30-50% better surface finish, reduced vibration, and faster machining for complex geometry. Optimized for STM32F446-based boards like the FlexiHAL. See [S_CURVE_ACCELERATION.md](S_CURVE_ACCELERATION.md) for detailed information and [S_CURVE_ENHANCEMENT_ROADMAP.md](S_CURVE_ENHANCEMENT_ROADMAP.md) for planned advanced features.
